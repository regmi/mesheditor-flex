    ...
    <html>
        ...
        <body>
            <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="830" height="600">
                ...
                <param name="flashvars" value="nodes=100 20,100 100,100 200,200 200,200 100,200 20,&elements=0 1 4 0 ,0 4 5 0 ,1 2 3 4 1 &boundaries=0 1 1,1 2 1,2 3 2,3 4 3,4 5 3,&var_name=dm" />
                <!--[if !IE]>-->
